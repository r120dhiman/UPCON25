function Footer() {
  return (
    <footer className="bg-[#054f89] text-white w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 py-10 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2">
              <li><a href="/about-conference" className="text-gray-300 hover:text-white text-sm">About Conference</a></li>
              <li><a href="/registration" className="text-gray-300 hover:text-white text-sm">Registration</a></li>
              <li><a href="/paper-submission" className="text-gray-300 hover:text-white text-sm">Paper Submission</a></li>
