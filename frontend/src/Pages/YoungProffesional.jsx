...
function YoungProffesional() {
  const speakerData2 = {
    ...
    name: "Dr. Ramanuja Panigrahi",
    institution: "Assistant Professor, IIT Roorkee",
  ...
  return (
    <div className='min-h-screen relative'>
      ...
      <div className='container mx-auto px-3 py-6 relative z-10'>
        <h1 className='text-2xl md:text-4xl text-center font-semibold mb-12 backdrop-blur-3xl mx-auto bg-[#8C477E]/20 rounded-2xl'>YOUNG PROFESSIONAL PANELIST</h1>
